    ...
    public class RopeBridge : MonoBehaviour
    {
       ...
       // public float pull_force = 50;
        ...
        void Start()
        {
            ...
            distanceFromPoint = (int)Vector3.Distance(a: StartPoint.position, b: EndPoint.position);

            segmentLength = (int)(distanceFromPoint / ropeSegLen) + 1;
        ...
        {
            // SIMULATION
            Vector3 forceGravity = new Vector2(0f, -1f);
